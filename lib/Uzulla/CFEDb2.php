...
class CFEDb2
{
    ...
    static function getValuesByItemListAndColumnName($list, $col)
    {
        /** @var \Uzulla\CFEDb2[] $list */
        $val_list = array();
    ...
    public function deleteItem($PDO = null)
    { //事前処理が必要な場合、ここに継承させる
